...
1. `name`: The carrier's callsign and name information
    ...
    1. `vanityName`: The carrier's name as hexadecimal, before any filtering is applied.
    1. `filteredVanityName`: The carrier's name as hexadecimal, after applying FDev's obscenity filter.
